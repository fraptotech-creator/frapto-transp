  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // overflow-y-auto: o painel (menu lateral no celular) rola quando os
          // itens passam da altura da tela. flex-col já não usa transform de
          // centralização, então aqui basta o overflow.
