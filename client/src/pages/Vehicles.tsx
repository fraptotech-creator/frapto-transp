      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Gerenciar frotas e veículos</p>
          </div>
        </div>
        <VehicleDialog />
      </div>
              ...
              >
                ...
                <CardContent className="p-6 relative z-10">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-2xl font-bold tracking-tight text-white">{vehicle.placa}</p>
                    ...
                    <div className="flex items-center gap-4 pt-3 border-t border-white/10">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-400">{vehicle.ano}</span>
                      </div>
        ...
        <Card className="border-white/10 shadow-2xl gradient-card-strong">
          <CardContent className="p-12 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="text-lg font-semibold text-white">Nenhum veículo cadastrado</p>
                <p className="text-sm text-gray-400 mt-1">Comece adicionando seu primeiro veículo</p>
              </div>
            </div>
          </CardContent>
        </Card>
